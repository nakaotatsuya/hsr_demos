...
#a = np.random.multivariate_normal([2,2], [[1,0],[1,2]], 5)
#print(a)

#x = np.linspace(1,9,600)

#gd1 = mlab.normpdf(x, gmm.means_[0, -1], np.sqrt(gmm.covars_[0,0]))

# gd1 = mlab.normpdf(x, gmm.means_[0,0], np.sqrt(gmm.covars_[0,0]))
